...
if ($type === 'sous_lot') {
    $sql = "SELECT DISTINCT sous_lot_name FROM operation WHERE lot_name = ?  AND pj_operation='Bon sortie'";
    ...
    $sql = "SELECT DISTINCT nom_article FROM operation WHERE lot_name = ? AND sous_lot_name = ? AND pj_operation='Bon sortie'";
    $stmt = $conn->prepare($sql);
