...
$sql = "SELECT DISTINCT lot_name FROM operation WHERE   pj_operation='Bon entrée'";
...
$sql = "SELECT DISTINCT sous_lot_name FROM operation  WHERE   pj_operation='Bon entrée'";
$result = $conn->query($sql);
while ($row = $result->fetch_assoc()) {
...
$sql = "SELECT DISTINCT nom_article FROM operation where   pj_operation='Bon entrée'";
$result = $conn->query($sql);
while ($row = $result->fetch_assoc()) {
...
$sql = "SELECT DISTINCT nom_pre_fournisseur FROM operation  WHERE   pj_operation='Bon entrée'";
$result = $conn->query($sql);
while ($row = $result->fetch_assoc()) {
