...
$sql = "SELECT DISTINCT lot_name FROM operation WHERE  entree_operation > 0";
...
$sql = "SELECT DISTINCT sous_lot_name FROM operation  WHERE  entree_operation > 0";
$result = $conn->query($sql);
while ($row = $result->fetch_assoc()) {
...
$sql = "SELECT DISTINCT nom_article FROM operation where  entree_operation > 0";
$result = $conn->query($sql);
while ($row = $result->fetch_assoc()) {
...
$sql = "SELECT DISTINCT nom_pre_fournisseur FROM operation  WHERE  entree_operation > 0";
$result = $conn->query($sql);
while ($row = $result->fetch_assoc()) {
