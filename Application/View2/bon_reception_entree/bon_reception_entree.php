...
<div class="container mt-2 animated-bg">
    ...
    <div class="filter-wrapper" style="margin-bottom: 50px">
        ...
        <div class="input-group1">
            ...
            <input type="text" id="fournisseur" class="input-field" list="fournisseursDatalist" placeholder="Sélectionner un fournisseur">
