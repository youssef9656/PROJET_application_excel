...
<!--            <th style="min-width: 100px; padding: 5px">ID</th>-->
            ...
            <th style="min-width: 100px; padding: 5px">Réference</th>
            ...
            <th style="min-width: 100px; padding: 5px">depense_entre</th>
            <th style="min-width: 100px; padding: 5px">Prix</th>
            <th style="min-width: 100px; padding: 5px">depense_sortie</th>
...
//            echo '<td style="padding: 5px">' . htmlspecialchars($row['id']) . '</td>';
            ...
            echo '<td style="padding: 5px">' . htmlspecialchars($row['ref']) . '</td>';
            ...
            echo '<td style="padding: 5px">' . htmlspecialchars($row['depense_entre']) . '</td>';
            echo '<td style="padding: 5px">' . htmlspecialchars($row['prix_operation']) . '</td>';
            echo '<td style="padding: 5px">' . htmlspecialchars($row['depense_sortie']) . '</td>';
