...
<table id="fournisseursTable" class="table-bordered table table-striped table-hover">
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<a href="#" style="color:green;" class="modify-btn modifierFournisseurBtn" data-id="' . htmlspecialchars($row['id_fournisseur']) . '" data-name="' . htmlspecialchars($row['nom_fournisseur']) . '">';
