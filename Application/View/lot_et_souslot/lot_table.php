...
<table class="table-bordered">
    ...
    <tr>
        <th>ID Lot</th>
        <th>Lot Name</th>
        <th>Action</th> <!-- Colonne d'actions -->
    </tr>
    </thead>
    <tbody>
    <?php
