...
<div id="tableoperationdiv">
    ...
    <table id="operationTable" class="table table-striped table-hover table-bordered">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<a href="#" style="color:green;" class="modify-btn btn-modifier-article" data-id="' . htmlspecialchars($row['id']) . '" data-lot="' . htmlspecialchars($row['lot_name']) . '" data-sous-lot="' . htmlspecialchars($row['sous_lot_name']) . '" data-article="' . htmlspecialchars($row['nom_article']) . '">';
