...
<div id="tableoperationdiv">
    ...
    data-article="' . htmlspecialchars($row['nom_article']) . '"
    data-fournisseur="' . htmlspecialchars($row['fournisseur_name']) . '"
    data-service="' . htmlspecialchars($row['service_name']) . '"
    data-ref="' . htmlspecialchars($row['ref']) . '"
    data-entree="' . htmlspecialchars($row['entree']) . '"
    data-sortie="' . htmlspecialchars($row['sortie']) . '"
